  ...
  return (
    <section>
      ...
      <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
        <motion.div
          className="relative select-none overflow-hidden rounded-lg border bg-white p-2 hover:shadow hover:shadow-teal-200"
        ...
        >
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <p className="text-muted-foreground mt-2 flex items-center text-xs">
              <FontAwesomeIcon
                icon={faCheckCircle}
