  ...
  return (
    <section className="text-white">
      ...
      <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
        <motion.div
          className="relative select-none overflow-hidden rounded-lg border border-gray-700 bg-gray-800 p-2 hover:shadow hover:shadow-teal-500/20"
        ...
        >
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            <svg
              viewBox="0 0 24 24"
              className="h-12 w-12 fill-current text-teal-500"
            >
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-400">
                Modern, fast (high-performance), web framework for building
                APIs.
              </p>
            </div>
        ...
        >
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            <svg
              viewBox="0 0 24 24"
              className="h-12 w-12 fill-current text-blue-500"
            >
        ...
        >
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            <svg
              viewBox="0 0 24 24"
              className="h-12 w-12 fill-current text-cyan-500"
            >
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-400">
                UI components built using React and styled with Tailwind CSS.
              </p>
            </div>
            <p className="mt-2 flex items-center text-xs text-gray-400">
              <FontAwesomeIcon
