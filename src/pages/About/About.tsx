export const About = () => {
  return (
    <section
      id="features"
      className="container mx-auto space-y-6 rounded-lg bg-slate-50 px-4 py-8 md:py-12 lg:py-20"
    >
      ...
      <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
        <div className="relative select-none overflow-hidden rounded-lg border bg-white p-2 hover:shadow hover:shadow-teal-200">
